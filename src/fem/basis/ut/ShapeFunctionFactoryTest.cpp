...
namespace
{
void checkQuadrilateralNodalShapeFunctions(const ShapeFunctionFactory& f)
{
...
void checkQuadrilateralSideShapeFunctions(const ShapeFunctionFactory& f)
{
...
void checkQuadrilateralInternalShapeFunctions(const ShapeFunctionFactory& f)
{
...
void checkQuadrilateralShapeFunctions(const ShapeFunctionFactory& f)
{
    checkQuadrilateralNodalShapeFunctions(f);
    checkQuadrilateralSideShapeFunctions(f);
    checkQuadrilateralInternalShapeFunctions(f);
}

void checkTriangleNodalShapeFunctions(const ShapeFunctionFactory& f)
{
...
void checkTriangleSideShapeFunctions(const ShapeFunctionFactory& f)
{
...
void checkTriangleInternalShapeFunctions(const ShapeFunctionFactory& f)
{
...
void checkTriangleShapeFunctions(const ShapeFunctionFactory& f)
{
    checkTriangleNodalShapeFunctions(f);
    checkTriangleSideShapeFunctions(f);
    checkTriangleInternalShapeFunctions(f);
}

void checkShapeFunctionDerivatives(const ShapeFunctionFactory& f)
{
